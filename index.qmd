...
`praatpicture` is in the R package repository [CRAN](https://cran.r-project.org/web/packages/praatpicture/){target='_blank'}, and can be installed with the following command:
...
Puggaard-Rode, Rasmus (2024) `praatpicture`. A library for making flexible Praat Picture-style figures in R. *Proceedings of the 13th International Seminar on Speech Production*.
