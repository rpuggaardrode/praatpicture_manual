...
Some fancier coloring options are available when a pitch track is overlaid on spectrograms or waveforms; more on that in @sec-pitch-overlay and @sec-pitch-wave-overlay.
...
## Overlaying on waveform {#sec-pitch-wave-overlay}
